...
// to think about it.
//
// The lantern on the east lip is the Cistern's last bench. Past it the floor gives
// out into the drain, and the drain goes to the Diver.
...
export const doors = [
  ...
  { id: 'd_drain', at: [29, 17], to: 'c1_diver:d_top', requires: null },
];
...
export const rails = [{ kind: 'rail', at: [20, 11], to: [25, 11] }];
...
export const hints = { route: /** @type {import('../../core/types.js').Waypoint[]} */ ([[2, 12], [6, 12], [14, 12], [18, 12, 'throw:r'], [18, 12, 'recall'], [20, 10], [20, 10, 'ride:25'], [27, 12], [29, 16]]) };
